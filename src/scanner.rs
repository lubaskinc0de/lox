    ...
    pub fn new(source: &str) -> Self {
        Self {
            ...
            keywords: HashMap::from([
                ...
                (String::from("шаблон"), TokenType::CLASS),
                (String::from("пиздишь"), TokenType::ELSE),
                (String::from("нихуя"), TokenType::FALSE),
                (String::from("делаешь"), TokenType::FOR),
                (String::from("флексить"), TokenType::FUN),
                ...
                (String::from("хуя"), TokenType::TRUE),
                (String::from("сундук"), TokenType::VAR),
                (String::from("ебашь"), TokenType::WHILE),
            ]),
        }
    }
